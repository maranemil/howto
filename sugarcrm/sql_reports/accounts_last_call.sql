...
((SELECT CONCAT(c.first_name,'',c.last_name) FROM contacts AS c LEFT JOIN calls_contacts AS cc ON cc.contact_id = c.id WHERE cc.call_id = calls0000.id LIMIT 1)) AS 'Contact Person'
