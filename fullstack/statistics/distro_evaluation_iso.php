 ...
 * @return int
 */
function flipscore(int $input): int
{
    switch ($input) {
        case $input > 100 && $input < 200:
            $value = 10;
            break;
        case $input > 200 && $input < 300:
            $value = 9;
            break;
        case $input > 300 && $input < 400:
            $value = 8;
            break;
        case $input > 400 && $input < 500:
            $value = 7;
            break;
        case $input > 500 && $input < 600:
            $value = 6;
            break;
        case $input > 600 && $input < 700:
            $value = 5;
            break;
        case $input > 700 && $input < 800:
            $value = 4;
            break;
        case $input > 800 && $input < 900:
            $value = 3;
            break;
        case $input > 900 && $input < 1000:
            $value = 2;
            break;
        default:
            $value = 0;
