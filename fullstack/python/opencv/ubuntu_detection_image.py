...
#sys.path.append("..")
# https://github.com/EdjeElectronics/TensorFlow-Object-Detection-API-Tutorial-Train-Multiple-Objects-Windows-10?files=1
...
# https://stackoverflow.com/questions/46494160/from-utils-import-label-map-util-import-error-no-module-named-utils?noredirect=1&lq=1
...
# https://github.com/tensorflow/models/issues/3078
# https://pythonprogramming.net/tensorflow-object-detection-api-self-driving-car/

#os.chdir('.../anaconda/lib/python3.6/site-packages/tensorflow/models')
os.chdir('../../anaconda2/lib/python2.7/site-packages/tensorflow/models/');
