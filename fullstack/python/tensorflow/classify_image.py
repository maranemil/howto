...
os.environ["CUDA_VISIBLE_DEVICES"]="0" # ensure that a TF process only runs on CPU
...
DATA_URL = 'http://download.tensorflow.org/models/image/imagenet/' + FILENET
