...
ffmpeg  -i in.mp4 -i in.mp4 -filter_complex  "[1] fade=in:1:1:alpha=1,lutrgb="r=negval:g=negval:b=negval",fade=out:5000:1:alpha=0, scale=980:980, rotate=-0.95:c=none [ov1];[1] fade=in:1:1:alpha=1,lutrgb="r=negval:g=negval:b=negval", fade=out:5000:1:alpha=1, scale=980:980, rotate=0.95:c=none [ov2]; [0][ov1] overlay=900:100 [v1]; [v1][ov2] overlay=W-600:600 [v] " -map "[v]" -y  -t 10 -an  outlayer1.mp4
...
ffmpeg -i output1b.mp4 -i output1b.mp4 -filter_complex  "[1] fade=in:1:1:alpha=1, fade=out:5000:1:alpha=1, scale=880:880, perspective=x0=0:y0=0:x1=W:y1=40, rotate=-0.45:c=none [ov1];[1] fade=in:1:1:alpha=1, fade=out:5000:1:alpha=1, scale=1280:1280, perspective=x0=0:y0=0:x1=W:y1=40, rotate=0.45:c=none [ov2]; [0][ov1] overlay=300:300 [v1]; [v1][ov2] overlay=W-680:100 [v] " -map "[v]"  -y  -t 10  outlayer2.mp4


ffmpeg -i outlayer1.mp4 -vf rotate=PI/4,rotate=PI/270,"split [main][tmp]; [tmp] crop=iw:ih/2:0:0, vflip [flip]; [main][flip] overlay=0:H/2","crop=iw/1.2:ih:0:0,split[left][tmp];[tmp]hflip[right];[left][right] hstack",scale=1560:360 -y  -t 10 output2.mp4
...
ffmpeg -i output2b.mp4 -i output2b.mp4 -filter_complex  "[1] fade=in:1:1:alpha=1, fade=out:5000:1:alpha=1, scale=880:880, perspective=x0=0:y0=0:x1=W:y1=40, rotate=-0.45:c=none [ov1];[1] fade=in:1:1:alpha=1, fade=out:5000:1:alpha=1, scale=880:880, perspective=x0=0:y0=0:x1=W:y1=40, rotate=0.45:c=none [ov2]; [0][ov1] overlay=100:100 [v1]; [v1][ov2] overlay=W-680:100 [v] " -map "[v]"  -y  -t 10  outlayer3.mp4
