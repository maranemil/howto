...
ffmpeg -i output.mp4 -vf "hflip" -y -threads 2 -an output2.mp4

###########################################
# FFMPEG Perspective + Overlay
###########################################
#ffmpeg -i output2.mp4 -i output2.mp4 -filter_complex  "[1] fade=in:10:1:alpha=1, fade=out:5000:1:alpha=1, scale=480:480, rotate=-0.45:c=none [ov1];[1] fade=in:10:1:alpha=1, fade=out:5000:1:alpha=1, scale=480:480, rotate=0.45:c=none [ov2]; [0][ov1] overlay=100:100 [v1]; [v1][ov2] overlay=W-680:100 [v] " -map "[v]" -y -threads 2 output3.mp4
cp output2.mp4 output3.mp4
