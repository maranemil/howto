...
# master sp
for i in *.xm; do ffplay -i $i -af afreqshift=shift=-7,rubberband=420/432,rubberband=460/432,volume=volume=7dB,crystalizer=i=7:c=0 -autoexit -t 17  -hide_banner -loglevel error && echo $i; done
...
for i in *.xm; do ffplay -i $i -af afreqshift=shift=-q7,volume=volume=3dB,crystalizer=i=5:c=0,highpass=f=30,lowpass=f=6500,rubberband=420/432,rubberband=450/432 -autoexit -hide_banner -loglevel error && echo $i; done

for i in *.wav; do ffplay -i $i -af afreqshift=shift=-49,afreqshift=shift=+42qq,volume=volume=3dB,crystalizer=i=5:c=0,highpass=f=30,lowpass=f=6500,rubberband=420/432,rubberband=450/432 -ss 00:00:00 -autoexit -hide_banner -loglevel error -ac 2 && echo $i; done
