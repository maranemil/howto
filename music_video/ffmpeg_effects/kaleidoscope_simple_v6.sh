...
ffmpeg -i in.mp4 -i in.mp4 -filter_complex  "[1] fade=in:1:1:alpha=1, fade=out:5000:1:alpha=1, scale=1280:1280, perspective=x0=0:y0=0:x1=W:y1=40, rotate=-0.45:c=none [ov1];[1] fade=in:1:1:alpha=1, fade=out:5000:1:alpha=1, scale=880:880, perspective=x0=0:y0=0:x1=W:y1=40, rotate=0.45:c=none [ov2]; [0][ov1] overlay=200:200 [v1]; [v1][ov2] overlay=W-680:100 [v] " -map "[v]"  -y  -t 10 -an  outlayer1.mp4
